      ...
      <div className="container mx-auto px-4 md:px-8 py-8">
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="lg:w-1/2 space-y-4 md:space-y-6">
            <div className="space-y-4">
              ...
              <h1 className="text-xl md:text-3xl lg:text-4xl font-black text-gray-800 tracking-tight leading-tight flex flex-wrap items-center gap-2">
                {product.name}
            ...
            <div className="flex items-center gap-4 md:gap-5 py-0 md:py-2">
              <span className="text-3xl md:text-5xl font-black text-black flex items-center gap-1">
                <span className="text-xl md:text-3xl font-medium">৳</span>{displayPrice.toFixed(2)}
              </span>
              {displayOriginalPrice && displayOriginalPrice > displayPrice && (
                <span className="text-xl md:text-3xl text-gray-300 line-through flex items-center gap-1 font-medium">
                  <span className="text-base md:text-2xl">৳</span>{displayOriginalPrice.toFixed(2)}
                </span>
              )}
            </div>
            ...
            {attributeList.map(attr => (
              <div key={attr.name} className="space-y-3 py-1 md:py-2">
                  ...
                  {attr.values.map((val) => {
                    ...
                    return (
                      <button
                        ...
                        disabled={isDisabled}
                        className={`px-4 py-2 md:px-8 md:py-4 border md:border-2 rounded-none text-xs md:text-sm font-bold transition-all min-w-[3rem] md:min-w-[110px] shadow-sm ${isActive
                          ? 'bg-black border-black text-white shadow-lg md:shadow-xl'
                          : isDisabled
        ...
        <div className="mt-12 md:mt-24">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-16">
            ...
            {/* Right Column: Form */}
            <div className="bg-white p-6 md:p-10 rounded-none border border-gray-100 shadow-sm">
              <div className="mb-4 md:mb-6">
                <h3 className="text-lg md:text-xl font-black text-gray-800 mb-1 uppercase tracking-tight">Share Your Thoughts</h3>
              ...
              <div className="space-y-4 md:space-y-6">
                <textarea
                  ...
                  className="w-full border border-gray-200 rounded-none p-4 h-24 md:h-32 outline-none focus:border-black transition-all text-sm placeholder:text-gray-300 resize-none bg-gray-50/30"
                />
                ...
                <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
                  ...
                  <button
                    ...
                    className="w-full sm:w-auto bg-black hover:bg-gray-900 text-white font-black py-3 md:py-4 px-10 rounded-none transition-all text-[10px] uppercase tracking-[2px] shadow-lg disabled:opacity-50 active:scale-95"
                  >
