              ...
              <div className="bg-white rounded-[24px] shadow-sm border border-gray-100 p-8 md:p-10 animate-in fade-in duration-300">
                ...
                <form onSubmit={handleUpdateProfile} className="space-y-10">
                  ...
                  <div className="flex justify-end">
                    <button type="submit" disabled={isUpdating} className="bg-black text-white font-black px-12 py-4 rounded-2xl uppercase tracking-widest text-[11px] shadow-lg shadow-gray-200 hover:bg-gray-800 transition-all">
              ...
              <div className="space-y-8 animate-in fade-in duration-300">
                <div className="flex items-center justify-between">
                  ...
                  {!showAddressForm && (
                    <button
                      ...
                      className="flex items-center gap-2 bg-black text-white px-6 py-2.5 rounded-2xl text-xs font-black uppercase tracking-widest hover:bg-gray-800 shadow-xl shadow-gray-200 transition-all active:scale-95"
                    >
                ...
                {addresses.length === 0 && !showAddressForm ? (
                  <div className="bg-white rounded-[2rem] border border-gray-100 p-24 flex flex-col items-center text-center shadow-sm">
                    <div className="w-24 h-24 bg-gray-50 rounded-[2rem] flex items-center justify-center text-black mb-8 border border-gray-200">
                      <MapPin size={40} />
                    </div>
              ...
              <div className="space-y-8 animate-in fade-in duration-300">
                ...
                {wishlistProducts.length === 0 ? (
                  <div className="bg-white rounded-[2rem] border border-gray-100 p-24 flex flex-col items-center text-center shadow-sm">
                    ...
                    <button onClick={() => navigate('/products')} className="bg-black text-white font-black px-10 py-4 rounded-2xl uppercase text-xs tracking-widest hover:bg-gray-800 transition-all shadow-xl shadow-gray-200">Start Exploring</button>
                  </div>
                ) : (
