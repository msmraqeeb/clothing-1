            ...
            {!(isAdding === 'product' || editingItem?.type === 'product') ? (
              <>
                ...
                <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden shadow-sm">
                  ...
                  {/* Pagination Controls */}
                  <div className="flex items-center justify-between p-6 border-t border-gray-100 bg-slate-50/50">
                      ...
                      <div className="flex items-center gap-1">
                        {Array.from({ length: Math.ceil(products.length / itemsPerPage) }).map((_, i) => (
                          ...
                          (i + 1 === 1 || i + 1 === Math.ceil(products.length / itemsPerPage) || (i + 1 >= productsPage - 1 && i + 1 <= productsPage + 1)) ? (
                            ...
                            (i + 1 === productsPage - 2 || i + 1 === productsPage + 2) && <span key={i} className="text-gray-400 text-xs px-1">...</span>
                          )
                        ))}
                      </div>
                      <button
