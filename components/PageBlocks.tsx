            ...
            <div className="flex-1 w-full">
                <div className="bg-white p-8 md:p-10 rounded-none border border-gray-100 shadow-xl shadow-gray-100/50">
                    ...
                    <form className="space-y-6" onSubmit={(e) => { e.preventDefault(); alert('Message sent!'); }}>
                        ...
                        <button type="submit" className="w-auto px-10 py-4 bg-black text-white font-black uppercase tracking-widest text-xs rounded-none hover:bg-gray-900 transition-all hover:scale-105 shadow-lg shadow-gray-200">
                            Send Now
                        </button>
                    </form>
                </div>
